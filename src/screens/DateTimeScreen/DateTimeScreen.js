...
export default function DateTimeScreen() {
  ...
  const onChange = (event, selectedDate) => {
    ...
    setDate(currentDate);
    // setDateButtonText(DateArray[2] + ' ' + DateArray[1] + ' ' + DateArray[3]);
    // setTimeButtonText(DateArray[4]);
  };

  const onButtonPressed = () => {
    navigation.navigate('DateTimeDepartureScreen');
  }
    ...
    return (
        <View style={{
            ...
            style={{
                ...
                <Text style={styles.text_title}>Choose Date and Time of Arrive</Text>
    ...
    <View style={{alignItems: 'center', width: '100%', height: '100%'}}>
      ...
      <View style={{width: '100%', flex: 1}}>
        ...
        <View style={{alignItems: 'center'}}>
          <Text style={styles.titleSecond}>Date of your Arrive:</Text>
